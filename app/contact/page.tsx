...
export const metadata: Metadata = {
    title: "Contact",
    description:
        "Get in touch with Jamaica Basketball. Send us tips, story ideas, or collaboration inquiries.",
    ...
    return (
        <div className="mx-auto max-w-3xl px-4 py-8 lg:px-8">
            ...
            <div className="article-body">
                <p>
                    Have a story tip? Want to collaborate? Just want to talk basketball?
                ...
                <p>
                    <strong>Email:</strong>{" "}
                    <a href="mailto:hello@jamaicabasketball.online">
                        hello@jamaicabasketball.online
                    </a>
                </p>
                ...
                <h2>Story Tips</h2>
                <p>
                    If you have news, scores, or insider information about basketball in
                    Jamaica, send it our way. Community contributions help us cover the
                    sport more thoroughly across the island.
                </p>

                <h2>Media Inquiries</h2>
                <p>
                    For press, partnership, or sponsorship inquiries, please reach out via
                    email.
                </p>
            </div>
        </div>
